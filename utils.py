...
def create_stat_card(title, id):
    return dbc.Card(
        dbc.CardBody([
            html.H6(title, className="card-title mb-1", style={'fontSize': '0.9rem'}),
            html.Div(id = id)
        ]),
...
def create_dropdown_stat_cart(values, id):
    return dbc.Card(
        dbc.CardBody([
            html.H6('Выберите компанию', className="card-title mb-1", style={'fontSize': '0.9rem'}),
            dcc.Dropdown(
...
def get_statistic_coefs(data, type):
    ...
    return (
        html.P(f'{value:.4f}', className="card-text mb-0", style={'fontSize': '1.1rem', 'fontWeight': 'bold'}),
        html.P(f'{pvalue:.4f}', className="card-text mb-0", style={'fontSize': '1.1rem', 'fontWeight': 'bold'}),
        html.P(f'{pct_5:.4f}', className="card-text mb-0", style={'fontSize': '1.1rem', 'fontWeight': 'bold'})
    )
